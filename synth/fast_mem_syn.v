...
`endif
	...
	defparam
		...
		ram_block3a_0.init_file = "fast_mem.mif",
	...
	defparam
		...
		ram_block3a_1.init_file = "fast_mem.mif",
	...
	defparam
		...
		ram_block3a_2.init_file = "fast_mem.mif",
	...
	defparam
		...
		ram_block3a_3.init_file = "fast_mem.mif",
	...
	defparam
		...
		ram_block3a_4.init_file = "fast_mem.mif",
	...
	defparam
		...
		ram_block3a_5.init_file = "fast_mem.mif",
	...
	defparam
		...
		ram_block3a_6.init_file = "fast_mem.mif",
	...
	defparam
		...
		ram_block3a_7.init_file = "fast_mem.mif",
...
endmodule //fast_mem_altsyncram1

//synthesis_resources = M9K 8 sld_mod_ram_rom 1 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fast_mem_altsyncram
	( 
	address_a,
	clock0,
	data_a,
...
`endif
	...
	fast_mem_altsyncram1   altsyncram1
	( 
	.address_a(address_a),
	...
	defparam
		...
		mgl_prim2.node_name = 1179469133,
	...
	initial/*synthesis enable_verilog_initial_construct*/
 	begin
		$display("Warning: Memory initialization file fast_mem.mif is not found. This may result in inconsistent simulation results.");
	end
endmodule //fast_mem_altsyncram
//VALID FILE
...
`endif
	...
	fast_mem_altsyncram	fast_mem_altsyncram_component (
				.address_a (address),
				.clock0 (clock),
				.data_a (data),
				.rden_a (rden),
